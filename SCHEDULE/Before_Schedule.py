...
def getYear():
    days = []
    # 기사 기간 설정
    #dates = date_range("20210810", "20210810")
    dates = date_range("20210810", "20211008")
    for e in dates:
        days.append(e)
    return days
...
def start_crawlingYear():
    ...
    for d in days:
        ...
        for i in range(count):
            home_time, away_time,home, away, stadium = getSchedule(i)
...
def saveYearArticle():
    ...
    #구단 변경시 파일명 변경
    dataframe.to_csv('C:/Users/sojun/OneDrive/바탕 화면/SIG/dataset/Before_Schedule.csv', sep=',', na_rep='NaN', mode='a')
